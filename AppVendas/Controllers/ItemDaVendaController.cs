...
{
    public class ItemDaVendaController : Controller
    {
        private readonly ApplicationDbContext _context;

        public ItemDaVendaController(ApplicationDbContext context)
        {
            _context = context;
        }
